...
const defaultServices = [
  // Hair Services
  {
    ...
    description: "Signature tailored haircut with hot steam towel, wash, and luxury finish styling.",
    price: 299,
    duration: 35,
  ...
  },
  {
    ...
    name: "Haircut (Women)",
    category: "Hair Services",
    description: "Professional stylized haircut with organic shampoo wash, deep conditioning, and signature blowout.",
    price: 499,
    duration: 50,
  ...
  },
  {
    ...
    name: "Hair Spa",
    category: "Hair Services",
    description: "Deep conditioning steam massage therapy with essential charcoal and gold oils to revive dry locks.",
    price: 899,
    duration: 45,
  ...
  // Skin Services
  {
    ...
    description: "Active blackhead removal, organic scrub wash, steam massage and detox masks.",
    price: 399,
    duration: 40,
  ...
  },
  {
    ...
    name: "Gold Facial",
    category: "Skin Services",
    description: "Luxury 24k gold leaf facial massage with skin whitening serum infusions and collagen masks.",
    price: 1599,
    duration: 60,
  ...
  // Nail Services
  {
    ...
    description: "Luxury hand scrub, nail profiling, cuticle conditioning, and premium gel coat polish.",
    price: 499,
    duration: 35,
  ...
  // Bridal Services
  {
    ...
    description: "Premium HD airbrush bridal makeup package with hair styling, saree draping, and setting service.",
    price: 7999,
    duration: 180,
