...
const fallbackServices = [
  { _id: "service_22", name: "Keratin (Medium)", category: "Women's Services", subcategory: "Keratin", price: 8500, duration: 150, rating: 4.9, description: "Deep protein smoothing treatment to eliminate frizz and add shine (Medium hair).", imageUrl: "https://images.unsplash.com/photo-1562322140-8baeececf3df?auto=format&fit=crop&q=80&w=600" },
  { _id: "service_43", name: "Advance Hair Cut (Shampoo + Conditioner + Setting)", category: "Women's Services", subcategory: "Hair Cut", price: 1200, duration: 50, rating: 5.0, description: "Couture haircut including shampoo wash, conditioner, and blow dry setting.", imageUrl: "https://images.unsplash.com/photo-1562322140-8baeececf3df?auto=format&fit=crop&q=80&w=600" },
  { _id: "service_69", name: "Classic Facial - Golden", category: "Women's Services", subcategory: "Classic Facial", price: 1700, duration: 60, rating: 4.8, description: "Exquisite classic skin therapy utilizing active golden extracts.", imageUrl: "https://images.unsplash.com/photo-1512290923902-8a9f81dc236c?auto=format&fit=crop&q=80&w=600" },
  { _id: "service_72", name: "Advance Gold Facial", category: "Women's Services", subcategory: "Premium Facial", price: 2500, duration: 60, rating: 4.9, description: "Luxury advanced clinical treatment specifically formulated as a gold therapy.", imageUrl: "https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?auto=format&fit=crop&q=80&w=600" },
  { _id: "service_78", name: 'Brightening & Whitening Facial "Bridal Special"', category: "Women's Services", subcategory: "Signature Facial", price: 4500, duration: 90, rating: 5.0, description: "The ultimate Brightening & Whitening premium bridal glow face ritual.", imageUrl: "https://images.unsplash.com/photo-1512290923902-8a9f81dc236c?auto=format&fit=crop&q=80&w=600" },
  { _id: "service_84", name: "Full Face Threading", category: "Women's Services", subcategory: "Threading", price: 200, duration: 25, rating: 4.7, description: "Precision threading and profiling for full face.", imageUrl: "https://images.unsplash.com/photo-1604654894610-df63bc536371?auto=format&fit=crop&q=80&w=600" },
  { _id: "service_105", name: "D Tan Manicure", category: "Women's Services", subcategory: "Manicure", price: 700, duration: 45, rating: 4.8, description: "Luxury therapeutic skin exfoliating and profiling ritual for hands.", imageUrl: "https://images.unsplash.com/photo-1604654894610-df63bc536371?auto=format&fit=crop&q=80&w=600" },
  { _id: "service_115", name: "Stylish Hair Cut", category: "Men's Services", subcategory: "Grooming", price: 229, duration: 40, rating: 4.8, description: "Premium men's grooming and styling service: stylish hair cut.", imageUrl: "https://images.unsplash.com/photo-1621605815971-fbc98d665033?auto=format&fit=crop&q=80&w=600" },
  { _id: "service_136", name: "In Saloon", category: "Men's Services", subcategory: "Special Groom Package", price: 5999, duration: 180, rating: 4.9, description: "Exclusive groom ritual bundle package: in saloon.", imageUrl: "https://images.unsplash.com/photo-1621605815971-fbc98d665033?auto=format&fit=crop&q=80&w=600" },
  { _id: "service_182", name: "Marriage", category: "Women's Services", subcategory: "Bridal Makeup", price: 18000, duration: 180, rating: 5.0, description: "Signature ultimate high-definition bridal makeup and bridal look.", imageUrl: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&q=80&w=600" }
];
...
const Catalog = () => {
  ...
  // Grouping sorted services by subcategory
  const servicesBySubcategory = React.useMemo(() => {
    const groups = {};
    sorted.forEach(srv => {
  ...
  const categories = ['All', "Women's Services", "Men's Services"];
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto">
        {loading ? (
          ...
          <div className="space-y-12">
            {Object.entries(servicesBySubcategory).map(([subcat, subcatServices]) => (
              <div key={subcat} className="space-y-6">
                <h3 className="font-heading text-lg font-bold uppercase tracking-wider text-[#D4AF37] border-b border-white/5 pb-2">
                  {subcat}
                </h3>
                {viewMode === 'grid' ? (
