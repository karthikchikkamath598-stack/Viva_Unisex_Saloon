...
const fallbackServices = [
  { _id: "s1", name: "Premium Haircut & Styling (Men)", category: "Hair Services", price: 299, duration: 45, rating: 4.9, description: "Tailored haircut with consultation, signature wash, relaxing head massage, and hot towel finish.", imageUrl: "https://images.unsplash.com/photo-1503951914875-452162b0f3f1?auto=format&fit=crop&q=80&w=600" },
  { _id: "s2", name: "Designer Cut & Blowout (Women)", category: "Hair Services", price: 499, duration: 60, rating: 5.0, description: "Couture haircut personalized to your hair profile, finished with a professional luxury blowout.", imageUrl: "https://images.unsplash.com/photo-1562322140-8baeececf3df?auto=format&fit=crop&q=80&w=600" },
  { _id: "s3", name: "Organic Keratin Infusion", category: "Hair Services", price: 3499, duration: 120, rating: 4.8, description: "Premium formaldehyde-free smoothing treatment that eliminates frizz, adds shine, and restores hair structure.", imageUrl: "https://images.unsplash.com/photo-1595853035070-59a39fe84de3?auto=format&fit=crop&q=80&w=600" },
  { _id: "s4", name: "Signature Balayage & Tonal Gloss", category: "Hair Services", price: 2999, duration: 150, rating: 4.9, description: "Artisanal hand-painted highlights customized to your skin tone, completed with a nourishing glaze.", imageUrl: "https://images.unsplash.com/photo-1620331702289-448a044618a4?auto=format&fit=crop&q=80&w=600" },
  { _id: "s5", name: "Golden Elixir Hydra Facial", category: "Skin Services", price: 1599, duration: 75, rating: 4.9, description: "Advanced multi-step facial using 24k gold leaf serums, deep vacuum extraction, and hyperbaric oxygen.", imageUrl: "https://images.unsplash.com/photo-1512290923902-8a9f81dc236c?auto=format&fit=crop&q=80&w=600" },
  { _id: "s6", name: "Deep Cleansing Organic Facial", category: "Skin Services", price: 399, duration: 50, rating: 4.7, description: "Detoxifying facial utilizing botanical enzymes, steam extraction, and custom clay treatment masks.", imageUrl: "https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?auto=format&fit=crop&q=80&w=600" },
  { _id: "s7", name: "Royal Beard Grooming & Sculpt", category: "Grooming", price: 299, duration: 30, rating: 4.8, description: "Precision beard shaping with hot steam, luxury pre-shave oil, straight-razor detailing, and conditioning balm.", imageUrl: "https://images.unsplash.com/photo-1503951914875-452162b0f3f1?auto=format&fit=crop&q=80&w=600" },
  { _id: "s9", name: "Signature Gel Manicure", category: "Nail Services", price: 499, duration: 40, rating: 4.8, description: "Nail shaping, cuticle therapy, organic scrub, massage, and high-gloss long-lasting gel polish.", imageUrl: "https://images.unsplash.com/photo-1604654894610-df63bc536371?auto=format&fit=crop&q=80&w=600" },
  { _id: "s10", name: "Chrome Gel Nail Extensions", category: "Nail Services", price: 799, duration: 75, rating: 4.9, description: "Premium full-set acrylic or gel extension overlays with chrome detailing and hand-painted metallic accents.", imageUrl: "https://images.unsplash.com/photo-1632345031435-8797b2d58045?auto=format&fit=crop&q=80&w=600" },
  { _id: "s11", name: "Imperial Bridal Makeover & Styling", category: "Bridal Services", price: 7999, duration: 180, rating: 5.0, description: "The ultimate bridal package: HD airbrush makeup, couture hair design, outfit draping, and setting service.", imageUrl: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&q=80&w=600" }
];
